...
// const images = ['kirin.jpg', 'secondwind.jpg', 'skeleton.jpg', 'angel.JPG' ];
...
export default function HomePage() {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const images = ['kirin.jpg', 'secondwind.jpg', 'skeleton.jpg', 'angel.JPG', 'nightlife2.jpg', 'metvoyager.jpg'];
  const location = useLocation();
  ...
  useEffect(() => {
    intervalRef.current = setInterval(() => {
      setCurrentImageIndex(prevIndex => (prevIndex + 1) % images.length);
    }, 6000); // Adjust the interval time as needed (in milliseconds)
